    ...
    <div className="sm:p-0 p-6">
      {property && (
        <>
          ...
          <AditionalInfo propertyTypeName={property.propertyTypeName} size={property.size} numberOfRooms={property.numberOfRooms} numberOfPeople={property.numberOfPeople} />
