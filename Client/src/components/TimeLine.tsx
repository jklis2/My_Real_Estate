    ...
    <section className="my-10">
      ...
      <ol className="relative border-s border-gray-400">
        <li className="mb-10 ms-4 ">
          ...
          <h3 className="text-lg font-semibold text-neutral-700 ">Application UI code in Tailwind CSS</h3>
        ...
        <li className="mb-10 ms-4">
          ...
          <h3 className="text-lg font-semibold text-neutral-700 ">Marketing UI design in Figma</h3>
