...
export default function UploadAvatar() {
  ...
  function onFileChange(e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) {
  ...
  return (
    <>
      <section className="my-10">
        ...
        <Input id="fileInput" type="file" name="file" className="file:bg-slate-300 file:py-2 file:px-6 file:rounded-full file:border-none file:cursor-pointer" onChange={onFileChange}></Input>
      </section>

      {alertData?.isVisible && <Alert name={alertData.name} type={alertData.type as 'Success' | 'Error'} isVisible={true} onClose={handleClose} />}
    </>
  );
}
