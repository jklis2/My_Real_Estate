...
export default function AditionalInfo({ propertyTypeName, size, numberOfRooms, numberOfPeople }: AditionalInfoProps) {
  return (
    <section className="my-10">
      <H2 className="mb-6">Aditional Information</H2>
      <div className="flex flex-wrap gap-8">
        <FeatureCard name={`Type: ${propertyTypeName}`} icon={<PiTree size={20} />} />
